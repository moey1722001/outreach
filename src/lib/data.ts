...
const sampleLeads: Lead[] = [
  hydrateLead({
    ...
    phone: '',
    contactPageUrl: 'https://example.org/inner-west-support/contact',
    linkedinUrl: '',
    status: 'qualified',
    likelihood: 86,
  ...
  hydrateLead({
    ...
    phone: '',
    contactPageUrl: 'https://example.org/northern-home-care/contact',
    linkedinUrl: '',
    status: 'drafted',
    likelihood: 78,
...
function hydrateLead(partial: Partial<Lead> & Pick<Lead, 'id' | 'organisation' | 'category'>): Lead {
  ...
  return {
    ...
    email: partial.email ?? '',
    phone: partial.phone ?? '',
    contactPageUrl: partial.contactPageUrl ?? '',
